...
If you want to help others using CLP you are welcome to extend the [Wiki on GitHub](https://github.com/MasterJi27/CorsairLightingProtocol/wiki).

## Finding information

General information can be found in the [Readme](https://github.com/MasterJi27/CorsairLightingProtocol) file at the root of the project.
Information about specific topics are written in the [Wiki](https://github.com/MasterJi27/CorsairLightingProtocol/wiki).
For developer there is also an [API documentation](https://masterji27.github.io/CorsairLightingProtocol/) for all the public methods and types.
